...
CREATE table likes (
id serial primary key comment "Идентификатор дейсвия",
content_id INT UNSIGNED NOT NULL COMMENT "Ссылка на пост",
user_id INT UNSIGNED NOT NULL unique COMMENT "Ссылка на пользователя, поставившего +", 
